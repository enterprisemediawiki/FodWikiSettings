$(document).ready(function(){
	...
	$(".ims-part-number-search").each(function(index,element){
		...
		var partnumber = $(element).html().trim();
	...
	$(".ims-item-search").each(function(index,element){
		...
		var cagecode     = $(element).find(".cagecode").html().trim();
		var partnumber   = $(element).find(".partnumber").html().trim();
		var serialnumber = $(element).find(".serialnumber").html().trim();
